...
class ExportMapOptionsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.format_combo.addItems(["GEOTIFF", "PNG", "JPEG", "SVG", "PDF"])  # 'JPEG' (combina com o serviço)
        ...
        self.chk_scale = QCheckBox("Incluir escala"); self.chk_scale.setChecked(True)
        ...
        layout.addWidget(self.chk_border); layout.addWidget(self.chk_scale); layout.addWidget(self.chk_time); layout.addWidget(self.chk_legend)
    ...
    def get_options(self):
        return ExportMapOptions(
            ...
            include_scalebar=self.chk_scale.isChecked(),  # nome correto
